...
if [ $layer_info -ne 0 ];then
	echo "Adding meta-finalproject layer"
	bitbake-layers add-layer ../meta-finalproject
else
	echo "meta-finalproject layer already exists"
fi
...
set -e
bitbake core-image-finalproject
